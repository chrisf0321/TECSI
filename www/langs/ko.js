...
var language = {
    ...
    "Play Game!" : "게임을 플레이!",
    "How to Play" : "게임 방법",
    "Crisis Support" : "위기 지원",
    "Disclaimer" : "면책 조항",
    "Current Score: " : "현재 점수 : ",
    "High Score: " : "높은 점수 : ",
    "Games Played: " : "게임 플레이 : ",
    "Overall Points: " : "전체 포인트 : ",
    "Average Points: " : "평균 포인트 : ",
    "gmStats" : "게임 기록",
    "back" : "백",
    "Resources" : "자원",
    "res1" : "당신이 자살 느낌이 있다면, 연락 주시기 바랍니다 :",
    "res2" : "미국 사용자",
    "res3" : "자살 예방 핫라인 : ",
    "res4" : "라인 자살 핫라인을 희망 : ",
    "res5" : "전화 ",
    "res6" : "미국과 비 미국 사용자",
    "res7" : "지역 정신 병원의 워크 인 클리닉",
    "res8" : "지역 병원의 응급실",
    "res9" : "지역 응급 의료 센터 나 클리닉",
    "res10" : "국제 자살 핫라인",
    "res11" : "국제 자살 위기 센터 정보",
    "res12" : "국제 자살 위기 라인",
    "inst" : "명령",
    "inst1" : "절반은 절반이 일치하는 게임이다",
    "inst2" : "목표는이 같은 그리드 내에서 다른 이미지 / 단어로 하나의 이미지 / 단어와 일치하는 것입니다 :",
    "inst4" : "어떻게 당신은 무엇에 맞게 알 수 있습니까?",
    "inst5" : "각 게임의 시작에서, 당신은이 같은 이미지 / 단어 세 쌍을 제공하고 있습니다 :",
    "inst7" : "당신은 어떻게 쌍을 일치합니까?",
    "inst8" : "그 쌍 중 하나는 각 게임 화면에 나타납니다. 있다 ",
    "inst9" : " 총 게임 화면.",
    "inst10" : "가능한 한 빨리 쌍의 구성원에 누릅니다. ",
    "inst11" : "빠른",
    "inst12" : " 더 ",
    "inst13" : "정확한",
    "inst14" : " 당신은 당신이 얻을 더 많은 포인트입니다.",
    "inst16" : "절반 절반은 더 도전 도착",
    "inst17" : "이미지 / 단어 옵션을 사용하면 첫 번째 이미지 / 단어를 선택 후에 검은 색으로 시작합니다",
    "inst18" : "그리고 절반 절반이 훨씬 더 도전 도착",
    "inst19" : "격자의 크기가 두 배로",
    "finish" : "완료!",
    "main" : "메인 메뉴",
    "matches" : "성냥",
