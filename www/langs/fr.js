...
var language = {
    ...
    "Crisis Support" : "Crise Soutien",
    "Disclaimer" : "Désistement",
    "Current Score: " : "Score actuel: ",
    "High Score: " : "High Score: ",
    "Games Played: " : "Matches joués: ",
    "Overall Points: " : "Total des points: ",
    "Average Points: " : "Moyenne de points: ",
    "gmStats" : "Stats de la partie",
    "back" : "Arrière",
    "Resources" : "ressources",
    "res1" : "Si vous vous sentez suicidaire, se il vous plaît contacter:",
    "res2" : "Les utilisateurs américains",
    "res3" : "Suicide Hotline de prévention: ",
    "res4" : "HopeLine Suicide Hotline: ",
    "res5" : "appel ",
    "res6" : "Les utilisateurs américains et non-américains",
    "res7" : "Rendez-vous dans la clinique de l'hôpital psychiatrique local",
    "res8" : "La salle d'urgence de votre hôpital local",
    "res9" : "Votre centre de soins d'urgence ou à la clinique locale",
    "res10" : "Permanences suicide internationales",
    "res11" : "Information internationale du suicide de centre de crise",
    "res12" : "Les lignes internationales de crise de suicide",
    "inst" : "Instructions",
    "inst1" : "Tec-Tec est un jeu d'association",
    "inst2" : "L'objectif est de faire correspondre une image / mot avec une autre image / mot dans une grille comme ceci:",
    "inst4" : "Comment savez-vous quoi correspond?",
    "inst5" : "Au début de chaque jeu, vous êtes donné trois paires d'images / mots, comme ceci:",
    "inst7" : "Comment avez-vous correspondre paires?",
    "inst8" : "Un de ces paires se affiche sur chaque écran de jeu. Il y a ",
    "inst9" : " écrans totaux de jeu.",
    "inst10" : "Appuyez sur les membres de la paire aussi rapidement que possible. Le ",
    "inst11" : "plus vite",
    "inst12" : " et de plus ",
    "inst13" : "précis",
    "inst14" : " vous êtes, plus vous gagnez de points.",
    "inst16" : "Tec-Tec devient plus difficile",
    "inst17" : "Options image / de mots commencent à noircir après avoir sélectionné la première image / mot:",
    "inst18" : "Puis Tec-Tec devient encore plus difficile",
    "inst19" : "La grille double de taille:",
    "finish" : "Fini!",
    "main" : "Menu principal",
    "matches" : "Allumettes",
    "start" : "Commencez jeu!",
