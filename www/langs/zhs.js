...
var language = {
    ...
    "res12" : "国际自杀危机线",
    "inst" : "说明",
    "inst1" : "TEC-Tec的是一个配对游戏",
    "inst2" : "我们的目标是一致的一个图像/字具有这样的网格内的另一图像/词语：",
    "inst4" : "你怎么知道该怎么搭配？",
    "inst5" : "在每场比赛开始，你给3双图像/文字，就像这样：",
    "inst7" : "你如何搭配双？",
    "inst8" : "其中一个对将出现在每个游戏的画面上。有 ",
    "inst9" : " 总的游戏画面。",
    "inst10" : "轻按一对成员尽快。该 ",
    "inst11" : "快点",
    "inst12" : " 多 ",
    "inst13" : "准确",
    "inst14" : " 你是，更多的积分，你得到的。",
    "inst16" : "TEC-Tec的变得更具挑战性",
    "inst17" : "图片/ Word选项开始黑您选择的第一张图像/字出来后：",
    "inst18" : "那么TEC-Tec的会变得更具挑战性",
    "inst19" : "网格的大小加倍：",
    "finish" : "完了！",
    "main" : "主菜单",
    "matches" : "火柴",
